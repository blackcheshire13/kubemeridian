...
export class DaemonsetCard extends PureComponent<Props>{
    ...
    getDaemonsetDashboardLink(){
        return `d/DXW019Dnz/kubemeridian-daemonsets-dashboard?orgId=${this.orgId}&var-cluster=${this.clusterName}&var-namespace=${this.daemonset.data.metadata.namespace}&var-daemonset=${this.daemonset.name}`;
    }
