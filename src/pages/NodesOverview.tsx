                        ...
                        <div className='row'>
                            <div className='col-md-5'>
                                <TabsBar hideBorder={true}>
                                    ...
                                    <Tab href={this.generateApplicationsOverviewLink()} label={'Applications Overview'}  onChangeTab={() => {}}/>
                                    <Tab href={this.generateNodesOverviewLink()} label={'Nodes Overview'} active={true}  onChangeTab={() => {}}/>
                                </TabsBar>
                            </div>
                            {this.isAdmin && (
